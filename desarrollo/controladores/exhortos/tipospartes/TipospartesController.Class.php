...
class TipospartesController {
    ...
    public function selectTipospartes($TipospartesDto, $param = null) {
        ...
        $TipospartesDto = $TipospartesDao->selectTipospartes($TipospartesDto, " ORDER BY descTipoParte ASC ", null, $param, null);
        return $TipospartesDto;
    }
    ...
    public function insertTipospartes($TipospartesDto, $proveedor = null) {
        ...
        $this->bitacora($dtoToJson, "49", "Insert en ".get_class($this)."");
        return $TipospartesDto;
    }
...
//if($tmpDto!=""){//$TipospartesDto->setFechaRegistro($tmpDto[0]->getFechaRegistro());
        ...
        $dtoToJson = new DtoToJson($TipospartesDto);
        $this->bitacora($dtoToJson, "50", "Update en ".get_class($this)."");
        return $TipospartesDto;
//}
//return "";
    }
    ...
    public function getPaginas($tipospartesDto, $param) {
        ...
        $numTot = $TipospartesDao->selectTipospartes($tipospartesDto, null, "", null, " count(cveTipoParte) as totalCount ");
