...
class Decode_JSON {
    ...
    function encode($var) {
        switch (gettype($var)) {
            ...
            case 'array':
                if (is_array($var) && count($var) && (array_keys($var) !== range(0, sizeof($var) - 1))) {
                    ...
                    foreach ($properties as $property) {
                        if (Decode_JSON::isError($property)) {
                            return $property;
                        }
                    }
                ...
                foreach ($elements as $element) {
                    if (Decode_JSON::isError($element)) {
                        return $element;
                    }
                }
            ...
            default:
                return ($this->use & SERVICES_JSON_SUPPRESS_ERRORS) ? 'null' : new _JSON_Error(gettype($var) . " can not be encoded as JSON string");
        }
    }
    ...
    function name_value($name, $value) {
        ...
        if (Decode_JSON::isError($encoded_value)) {
    ...
    function decode($str, $array = false) {
...
if (class_exists('PEAR_Error')) {
    ...
    class Decode_JSON_Error extends PEAR_Error {

        function Decode_JSON_Error($message = 'unknown error', $code = null, $mode = null, $options = null, $userinfo = null) {
